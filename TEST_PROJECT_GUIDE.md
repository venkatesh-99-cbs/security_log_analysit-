...
4. Review the details:
   - Mapped tactics under the **MITRE ATT&CK Heatmap Matrix** (e.g., `T1110` highlighted under the *Credential Access* column).
...
3. The server queries Ollama locally:
   ...
   - The result is rendered in clean markdown formatting showing: *Executive Summary*, *Attack Analysis*, *Immediate Containment Steps*, and *Long-Term Hardening Recommendations*.
